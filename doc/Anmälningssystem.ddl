...
CREATE TABLE LarperTypes (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, Descrption text NOT NULL, Active tinyint(1) DEFAULT 1 NOT NULL, SortOrder int(11), PRIMARY KEY (Id));
CREATE TABLE IntrigueTypes (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, Descrption text NOT NULL, Active tinyint(111) DEFAULT 1 NOT NULL, SortOrder int(11), PRIMARY KEY (Id));
...
CREATE TABLE Wealths (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, Descrption text NOT NULL, Active tinyint(1) DEFAULT 1 NOT NULL, SortOrder int(11), PRIMARY KEY (Id));
...
CREATE TABLE Origins (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, Descrption text NOT NULL, Active tinyint(1) DEFAULT 1 NOT NULL, SortOrder int(11), PRIMARY KEY (Id));
