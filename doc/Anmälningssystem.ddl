...
CREATE TABLE LARPs (id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, Abbreviation varchar(10) NOT NULL, Year int(10) NOT NULL, TagLine varchar(255), Startdate date, EndDate date, MaxParticipants int(11) NOT NULL, LatestRegistrationDate date, PRIMARY KEY (id));
...
CREATE TABLE Interests (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, Description text NOT NULL, PRIMARY KEY (Id));
...
CREATE TABLE LarperTypes (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, Descrption text NOT NULL, PRIMARY KEY (Id));
CREATE TABLE IntrigueTypes (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, Descrption text NOT NULL, PRIMARY KEY (Id));
...
CREATE TABLE Experiences (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, Description text NOT NULL, PRIMARY KEY (Id));
CREATE TABLE HousingRequests (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, Description text NOT NULL, PRIMARY KEY (Id));
CREATE TABLE TypesOfFood (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, Description text, PRIMARY KEY (Id));
CREATE TABLE Wealths (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, Descrption text NOT NULL, PRIMARY KEY (Id));
CREATE TABLE Telegrams (Id int(11) NOT NULL, Deliverytime varchar(255) NOT NULL, Sender varchar(255) NOT NULL, SenderCity varchar(255) NOT NULL, Reciever varchar(255) NOT NULL, RecieverCity varchar(255) NOT NULL, Message text NOT NULL, OrganizerNotes text, PRIMARY KEY (Id));
CREATE TABLE Origins (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, Descrption text NOT NULL, PRIMARY KEY (Id));
...
CREATE TABLE OfficialTypes (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, Descrption text NOT NULL, PRIMARY KEY (Id));
...
CREATE TABLE NormalAllergyTypes (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, Description text, PRIMARY KEY (Id));
