...
CREATE TABLE Characters (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, IsNPC tinyint(1) NOT NULL, Profession varchar(255) NOT NULL, Description mediumtext, PreviousLarps mediumtext, ReasonForBeingInSlowRiver text, Religion varchar(255), DarkSecret text, IntrigueSuggestions text, OtherInformation text, PersonsId int(11) NOT NULL, GroupsId int(11) NOT NULL, WealthsId int(11) NOT NULL, OriginsId int(11) NOT NULL, Photo longblob, PRIMARY KEY (Id));
CREATE TABLE Groups (Id int(11) NOT NULL AUTO_INCREMENT, Name varchar(255) NOT NULL, ApproximateNumberOfMembers int(10) NOT NULL, NeedFireplace tinyint(1) NOT NULL, Friends text, Enemies text, WantIntrigue tinyint(1) NOT NULL, Description text NOT NULL, IntrigueIdeas text, OtherInformation text, WealthsId int(11) NOT NULL, OriginsId int(11) NOT NULL, PersonsId int(11) NOT NULL, PRIMARY KEY (Id));
...
CREATE TABLE Users (Id int(11) NOT NULL AUTO_INCREMENT, Email varchar(255) NOT NULL, Password varchar(255) NOT NULL, IsAdmin tinyint(1) DEFAULT 0 NOT NULL, ActivationCode varchar(255), PRIMARY KEY (Id));
