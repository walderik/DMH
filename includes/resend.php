...
function send_activation(User $user)  {
    ...
    BerghemMailer::sendSimpleEmail(null, null, $mail, $user->Name, "Hej ".$user->Name, $text, "Aktiveringsbrev", "Omnes Mundi", BerghemMailer::DaysAutomatic);
}
...
function send_change_password(User $user) {
    ...
    BerghemMailer::sendSimpleEmail(null, null, $mail, $user->Name, "Hej ".$user->Name, $text, "Byta Lösenord", "Omnes Mundi", BerghemMailer::DaysAutomatic);
}