...
function send_activation(User $user)  {
    ...
    BerghemMailer::send($mail, $user->Name, $text, "Aktiveringsbrev", BerghemMailer::DaysAutomatic);
}
...
function send_change_password(User $user) {
    ...
    BerghemMailer::send($mail, $user->Name, $text, "Byta Lösenord", BerghemMailer::DaysAutomatic);
}