...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($operation == 'main_organizer') {
        ...
        if ($person_id == 0) {
            ...
            $campaign->update();
            $mainOrganizerPerson = Person::loadById($campaign->MainOrganizerPersonId);
            if (!AccessControl::hasAccessCampaign($mainOrganizerPerson, $campaign->Id)) AccessControl::grantCampaign($mainOrganizerPerson, $campaign->Id);
        }
