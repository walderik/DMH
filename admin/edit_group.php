	...
	<div class="content">
		...
		<table>
			...
			<td>
    			...
    			<label for="Visibility_Not_Choose">Visas i listor över tex deltagare, men deltagare kan inte välja den för sina karaktärer</label><br> 
    			...
    			<label for="Visibility_Invisible">Visas inte för deltagare, mer än om de har en karaktär i gruppen</label>
			</td></tr>
