...
<div class="content">
    ...
    echo "<table class='data'><tr><th>Namn</th><th>Epost</th><th>Telefon</th><th>Typ av funktionär</th></tr>";
    ...
    echo "<table class='data'><tr><th>Namn</th><th>Epost</th><th>Telefon</th><th>Önskad typ av funktionär</th></tr>";
    foreach($persons as $person) {
        echo "<tr><td>$person->Name</td><td>$person->Email</td><td>$person->PhoneNumber</td><td>".commaStringFromArrayObject($person->getRegistration($current_larp)->getOfficialTypes())."</td></tr>";
    }
    echo "</table>";
