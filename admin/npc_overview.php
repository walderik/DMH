        ...
        <h1>Alla NPC</h1>
			...
			foreach ($npcs as $npc) {
			    ...
			    if (empty($assignement)) {
			        ...
			        echo "<input type='hidden' id='operation' name='operation' value='insert'><button class='invisible' type='submit'>".showStatusIcon(false)."</button></form>";
			        ...
			        echo "<form action='npc_form.php' method='POST'><input type='hidden' id='roleId' name='roleId' value='$npc->Id'>";
			        echo "<input type='hidden' id='operation' name='operation' value='update'><button class='invisible' type='submit'>".showWarningIcon()."</button></form>";
			    }
