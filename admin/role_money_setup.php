...
?>
    ...
    <div class="content">
        <h1>Sätt pengar på många karaktärer</h1>
         ...
         Om en karaktär har både rikedoms nivå och varit med på ett tidigare lajv så kommer den att få för rikedomsnivå + för tidigare lajv + den fasta summan.</p>
        ...
        <p>Så här mycket pengar ska en karaktär få utifrån hur rik den är.<br>Sätt 0 på pengar per rikedomsnivå om du inte vill att rikedomsnivå ska påverka hur mycket pengar de får.</p>
        	...
        	foreach ($wealths as $wealth) {
        	    ...
        	    echo "<br>";
        	    echo "<input type='number' id='wealth_$wealth->Id' name='wealth_$wealth->Id' value='0' required> $currency";
        	    echo "</div>";
        	}
        ...
        <p>Hur stor del av vad karaktären hade på tidigare lajv ska den få på det här lajvet.<br>
        Sätt procent till 0 om du inte vill att något tidigare lajv ska påverka pengarna på det här lajvet.</p>
			<div class="question">
			...
			<div class="question">
				<label for="percent">% av resultatet</label>&nbsp;<font style="color:red">*</font>
				<br> <input type="number" id="percent" name="percent" value="0" required>
			</div>
        ...
        Sätt summan till 0 om du inte vill lägga till en fast summa till alla karaktärer.</p>
			<div class="question">
				<label for="fixed_sum">Fast summa</label>&nbsp;<font style="color:red">*</font>
				<br> <input type="number" id="fixed_sum" name="fixed_sum" value="0" required> <?php echo $currency ?>
			</div>
