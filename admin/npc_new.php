...
function print_assigned_npc(Role $npc, Group $npc_group) {
    global $current_larp;
    echo "<tr><td width='80'>";
    if ($npc->hasImage()) {
...
function print_unassigned_npc(Role $npc) {
...
function print_npc(Role $npc) {
    global $persons, $current_larp;
    $intrigues = Intrigue::getAllIntriguesForNPC($npc->Id, $current_larp->Id);
    echo "<tr><td width='80'>";
    if ($npc->hasImage()) {
        echo "<img width='30' src='../includes/display_image.php?id=$npc->ImageId'/>\n";
        echo " <a href='logic/delete_image.php?id=$npc->Id&type=role'><i class='fa-solid fa-trash' title='Ta bort bild'></i></a>\n";
    } else {
        echo "<a href='upload_image.php?id=$npc->Id&type=role'><i class='fa-solid fa-image-portrait' title='Ladda upp bild'></i></a> \n";
    }
    echo "</td><td>";
    echo "<div class='npc'>";
    echo "<a href='edit_role.php?operation=update&id=$npc->Id'>$npc->Name</a> ";
    if (empty($intrigues)) echo "<a href='logic/delete_npc.php?id=$npc->Id'><i class='fa-solid fa-trash'></i></a> ";
...
div.npc {
    ...
    <div class="content">   
        <h1>NPC</h1>
            ...
            <a href="npc_group_form.php"><i class="fa-solid fa-file-circle-plus"></i>Skapa NPC grupp (gammal)</a>  
