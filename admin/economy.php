...
.amount {
  text-align: right;
	...
	<?php 
       ...
       echo "<tr><th>Nummer</th><th>Datum</th><th>Rubrik</th><th>Summa</th></tr>\n";
       ...
       echo "<tr><td></td><td>".substr($current_larp->EndDate,0,10)."</td><td>Deltagaravgifter</td><td class='amount'>$registration_fees</td></tr>";
       $returned_fees = Registration::totalFeesReturned($current_larp);
       $sum -= $returned_fees;
       echo "<tr><td></td><td>".substr($current_larp->EndDate,0,10)."</td><td>Återbetalade deltagaravgifter</td><td class='amount'>".(0-$returned_fees)."</td></tr>";
       echo "<tr></tr>";
       echo "<tr><th colspan='3'>Summa</th><th class='amount' style='text-align: right;'>$sum</th></tr>";
       echo "</table>";
       ?>
