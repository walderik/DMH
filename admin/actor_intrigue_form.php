	...
	<form action="view_intrigue.php" method="post">
		...
		<table>
			<tr>
				...
				<td><textarea id="IntrigueText" name="IntrigueText" rows="4" cols="100" maxlength="60000" required><?php echo htmlspecialchars($intrigueActor->IntrigueText); ?></textarea></td>
			</tr>
			<tr>
				<td><label for="Offinfo">Off-info</label></td>
				<td><textarea id="Offinfo" name="Offinfo" rows="4" cols="100" maxlength="60000" required><?php echo htmlspecialchars($intrigueActor->Offinfo); ?></textarea></td>
			</tr>
		</table>
