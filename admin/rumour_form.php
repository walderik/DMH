	...
	<form id="main" action="rumour_admin.php" method="post"></form>
		...
		<table>
			...
			<tr>
				...
				<td><?php if (!empty($intrigue_array)) selectionDropDownByArray("IntrigueId", $intrigue_array, false, $rumour->IntrigueId, null, "form='main'");?></td>
			</tr>
			<tr>

				<td>
					<label for="Text">Vem/vilka handlar<br>ryktet om?</label>
					<label for="Text">Dessa får det inte vid automatiskt fördelning.</label>
				</td>
				<td>
