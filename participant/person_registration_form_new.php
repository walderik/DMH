...
function printEditableCharacter($selectionArr, $selectedRoleId, $intrigueIdeas, $chosenIntrigueTypes, $isMainCharacter, $showBorder) {
    global $current_larp;
    if ($showBorder) echo "<div class='character'>";
    if ($isMainCharacter) {
 ...
 function printNonEditableCharacter($selectedRoleName, $intrigueIdeas, $chosenIntrigueTypes, $isMainCharacter) {
     global $current_larp;
     echo "<div class='character'>";
     echo "<div class='icons'><i class='fa-solid fa-pen'></i>";
     if (!$isMainCharacter) echo "<i class='fa-solid fa-trash'></i>";
     echo "</div>";
     if ($isMainCharacter) {
         $headline1 = "Huvudkaraktär";
     } else {
     ...
     if (!empty($chosenIntrigueTypes)) foreach ($chosenIntrigueTypes as $chosenIntrigueType) $selectedRoleName[] = IntrigueType::loadById($chosenIntrigueType)->Name;
     if (IntrigueType::isInUseForRole($current_larp)) {
         print_participant_question_start(
             "Intrigtyper",
             "",
