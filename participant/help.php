...
?>
	...
	<div class="content">
		<h1>Omnes Mundi - Hjälp</h1>

<p>Omnes Mundos (latin: alla världar) är vårt system för att hantera anmälningar, handel, husfördelning, brev, intriger, utvärderingar mm. Här beskrivs hur du använder systemet som deltagare.
</p>
<p>
...
<h3>2. Om du är gruppledare - Registrera och anmäl grupp</h3>
Under fliken “registrera” kan du välja “grupp”. Där kan du som tänkt vara gruppledare (=off-kontaktperson) för en grupp registrera en grupp. Denna grupp är knuten till den valda lajvkampanjen. Gruppen måste anmälas och godkännas innan någon karaktär kan välja att vara med i gruppen.
<h3>3. Registrera karaktär</h3>
...
<h3>4. Anmälan till lajvet</h3>
Om lajvet är öppet kan du anmäla en eller flera karaktärer till lajvet
<h2>Efter första gången</h2>
<h3>Vidare användning</h3>
...
<h2>Efter lajvet</h2>
<h3>Vad hände din karaktär/grupp?</h3>
