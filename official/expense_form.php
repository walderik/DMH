...
?>
    ...
    <div class="content"> 
    <h1><?php echo default_value('action');?> <?php echo default_value('sort');?> <a href="index.php"><i class="fa-solid fa-arrow-left" title="Tillbaka"></i></a></h1>
	...
	<form action="logic/expense_form_save.php" method="post" enctype="multipart/form-data">
